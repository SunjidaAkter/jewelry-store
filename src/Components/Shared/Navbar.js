            ...
            <div className='bg-[#F8F8F8] dark:bg-[#232323]'>
                <div className='px-16 py-[15px] flex lg:justify-between md:justify-end justify-end items-center'>
                    <div className='hidden lg:inline-flex gap-x-7'>
                        <p className='text-[.9rem] text-[#999999] dark:text-[#cfd4da] mb-0'><FontAwesomeIcon icon={faMailBulk} className='text-primary text-[.7rem] font-[300]' />{" "}multicart@gmail.com</p>
                    ...
                    <div className='inline-flex gap-x-7 items-center'>
                        ...
                        <div className='group'>
                            ...
                            <p className='group-hover:text-primary text-[#999999] dark:text-[#cfd4da]'><FontAwesomeIcon icon={faHeart} className='group-hover:text-primary text-primary'></FontAwesomeIcon> Wishlist</p>
                        </div>
                ...
                <div class="navbar-end">
                    <div className='inline-flex gap-x-7 items-center'>
                        ...
                        <div className='indicator'>
                            <span class="indicator-item badge badge-sm bg-primary border-0 mt-[-5px] py-[7px] px-[5px] text-white ">0</span>
