...
import { BadgeCheckIcon, ChatIcon, ClipboardCheckIcon, ClipboardIcon, UserAddIcon, UserIcon, ViewGridAddIcon, TrendingUpIcon } from "@heroicons/react/solid";
        ...
        <div class='drawer drawer-mobile mt-16 bg-white'>
            ...
            <div class='drawer-side '>
                ...
                <ul class="menu p-4 overflow-y-auto w-48 bg-base-100 text-base-content shadow-inner">
                    ...
                    <li><Link className="font-normal mt-2 flex text-[15px]  items-center" to="/dashboard"><TrendingUpIcon className="w-4 h-4 mr-1"></TrendingUpIcon> B. Summary</Link></li>
